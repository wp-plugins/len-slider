                ...
                <div id="post-body-content" class="has-sidebar-content">
                    ...
                    <form id="ls_settings_form" method="post" action="<?php echo admin_url("admin.php?page={$ls_settings->settingsPage}&noheader=true")?>">
                        ...
                        <table class="form-table flag-options">
                            <tr>
                                <th scope="row" width="250"><label for="<?php echo LenSlider::$slidersLimitName?>"><?php printf(__("Sliders limit<br /><span class=\"description\">(max: %d)</span>", 'lenslider'), $ls_settings->slidersLimitDefault)?></label></th>
                            ...
                            <tr>
                                <th scope="row" width="250"><label for="<?php echo LenSlider::$bannersLimitName?>"><?php printf(__("Banners limit for each slider<br /><span class=\"description\">(max: %d)</span>", 'lenslider'), $ls_settings->bannersLimitDefault)?></label></th>
                            ...
                            <tr>
                                <th scope="row" width="250"><label for="<?php echo LenSlider::$cacheName?>"><?php _e("Enable WordPress cache for sliders", 'lenslider')?></label></th>
                            ...
                            <tr>
                                <th scope="row" width="250"><label for="<?php echo LenSlider::$tipsyName?>"><?php _e("Tooltip hint", 'lenslider')?></label></th>
                        ...
                        <table class="form-table flag-options">
                            <tr>
                                <th scope="row" width="250"><label for="<?php echo LenSlider::$maxSizeName?>"><?php printf(__("Upload images maximum size, MB<br /><span class=\"description\">(max: %d)</span>", 'lenslider'), $ls_settings->imageFileSizeMAX)?></label></th>
                            ...
                            <tr>
                                <th scope="row" width="250"><label for="<?php echo LenSlider::$maxWidthName?>"><?php printf(__("Maximum image width, px<br /><span class=\"description\">(min: %1d; max: %2d)<br />proportions are kept</span>", 'lenslider'), $ls_settings->imageWidthMIN, $ls_settings->imageWidthMAX)?></label></th>
                            ...
                            <tr>
                                <th scope="row" width="250"><label for="<?php echo LenSlider::$qualityName?>"><?php printf(__("Maximum quality of uploaded image<br /><span class=\"description\">(min: %1d; max: %2d)<br />percents</span>", 'lenslider'), $ls_settings->imageQualityMIN, $ls_settings->imageQualityMAX)?></label></th>
                        ...
                        <table class="form-table flag-options">
                            <tr>
                                <th scope="row" width="250"><label for="<?php echo LenSlider::$backlink?>"><?php _e("I would like to support plugin creators and place a plugin link to my site", 'lenslider')?></label></th>
